...
class AdminRolesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.roles.create')->with('success','Role has been create');
    }
    ...
    public function update(Request $request, Role $role)
    {
        ...
        return redirect()->route('admin.roles.edit',$role)->with('success','Role has been update');
    }
