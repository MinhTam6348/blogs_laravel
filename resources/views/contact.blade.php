						...
						<form onsubmit="return false;" method="POST" >
							...
							<div class="row form-group">
								<div class="col-md-6">
									...
									<x-blog.form.input value='{{old("first_name")}}' placeholder="First Name" name="first_name"/>
									<small class='error text-danger first_name'></small>
								</div>
								<div class="col-md-6">
									<!-- <label for="lname">Last Name</label> -->
									<x-blog.form.input value='{{old("last_name")}}' placeholder="Last Name" name="last_name"/>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<x-blog.form.input value='{{old("email")}}' type="email"  placeholder="Email" name="email"/>
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<x-blog.form.input value='{{old("subject")}}' required="false"  placeholder="Subject" name="subject"/>
