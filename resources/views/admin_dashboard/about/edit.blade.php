                      ...
                      @csrf
                        ...
                        <div class="form-body mt-4">
                            ...
                            <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="mb-3">
                                        <label for="about_our_mission" class="form-label">About Our Mision</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea  name='about_services' id="about_services"  id="about_services" rows="3">{{ old("about_services", $setting->about_services ) }}</textarea>
