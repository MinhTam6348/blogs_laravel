                      ...
                      @method('PATCH')
                        ...
                        <div class="form-body mt-4">
                            ...
                            <div class="border border-3 p-4 rounded">
                                    ...
                                    onclick="event.preventDefault();document.getElementById('comment_delete_form{{ $comment->id}}').submit()"
                                    href="#">Delete Comment</a>
                            </div>
                        </div><!--end row-->
                    </form>
                    <form id='comment_delete_form{{ $comment->id}}' method='post' action="{{ route('admin.comments.destroy',$comment) }}">
                        @csrf
                        @method('DELETE')
                    </form>
                </div>
