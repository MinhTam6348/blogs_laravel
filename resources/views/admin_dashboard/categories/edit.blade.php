                            ...
                            <div class="col-lg-12">
                                <div class="border border-3 p-4 rounded">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"  value='{{ old("name", $category->name) }}' name='name'  required class="form-control"   id="inputProductTitle" placeholder="Enter product title">
                                        @error('title')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" value='{{ old("slug",$category->slug) }}' class="form-control" required  name='slug'  id="inputProductTitle" placeholder="Enter product title">
                                        @error('slug')
                                                <p class='text-danger'>{{ $message }}</p>
                                        @enderror
                                    </div>
