    ...
    <div class="page-content">
        ...
        <div class="card">
          <div class="card-body p-4">
              <h5 class="card-title">Edit Roles : {{ $role->name }}</h5>
              <hr/>
                    ...
                    <div class="form-body mt-4">
                        ...
                        <div class="border border-3 p-4 rounded">
                                <div class="mb-3">
                                    ...
                                    <input type="text"  value='{{ old("name", $role->name) }}' name='name'  required class="form-control"   id="inputProductTitle" placeholder="Enter product title">
                                    @error('name')
