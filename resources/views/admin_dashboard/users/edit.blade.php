                      ...
                      @method('PATCH')
                        <div class="form-body mt-4">
                            ...
                            <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class='col-md-4'>
                                            <div class='user-image'>
                                                <img src="{{$user->image ? asset('storage/' . $user->image->path) : asset('storage/placehoders/user_placehoder.jpg') }}" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                @foreach($roles as $key => $role) 
                                                    <option value="{{ $user->role_id === $key ? 'selected' : ''}}">{{$role}}</option>
                                                @endforeach
                                                </select>
                                    ...
                                    <a onclick='event.preventDefault(); document.getElementById("delete_user_{{ $user->id }}").submit()' href="#" class='btn btn-danger'>Delete User</a>
                            </div>
                        </div><!--end row-->
                    </form>
